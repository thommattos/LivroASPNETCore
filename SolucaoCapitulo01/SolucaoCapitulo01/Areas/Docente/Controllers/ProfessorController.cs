...
using SolucaoCapitulo01.Areas.Docente.Models;
using SolucaoCapitulo01.Data.DAL.Cadastros;
using SolucaoCapitulo01.Data.DAL.Docente;

namespace SolucaoCapitulo01.Areas.Docente.Controllers
{
    [Area("Docente")]
    public class ProfessorController : Controller
    {
            ...
            [Bind("InstituicaoID, DepartamentoID, CursoID, ProfessorID")] AdicionarProfessorViewModel model)
        {
            if (model.InstituicaoID == 0 || model.DepartamentoID == 0 ||
                ...
                ModelState.AddModelError("", "É precisso selecionar todos os dados");
            else
            {
        ...
        {
            var professores = cursoDAL.ObterProfessoresForaDoCurso(actionID);
